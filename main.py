...
def main():
    ...
    o3d.io.write_point_cloud("results/non_ground_cloud_000010.ply", non_ground_cloud)
    print("Saved non-ground cloud to results/non_ground_cloud_000010.ply")
    ...
    o3d.io.write_point_cloud("results/clustered_cloud_000010.ply", clustered_cloud)
    print("Saved clustered cloud to results/clustered_cloud_000010.ply")
    
    clusters = extract_clusters(non_ground_cloud, labels, min_cluster_points=20, max_cluster_points=5000)
